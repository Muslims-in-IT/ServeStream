...
public class Metadata
{
    ...
    /**
     * The metadata key to retrieve the album artwork.
     */
    public static final String METADATA_KEY_ARTWORK = "artwork";
     ...
     * {@hide}
     */
    public boolean parse(HashMap<String, Object> metadata) {
    	mMetadata = metadata;
