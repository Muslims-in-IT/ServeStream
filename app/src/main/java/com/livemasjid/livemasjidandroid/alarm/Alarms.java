...
package com.livemasjid.livemasjidandroid.alarm;
 ...
 */
public class Alarms {
	private final static String TAG = Alarms.class.getName();
	
    // This action triggers the AlarmReceiver as well as the AlarmKlaxon. It
    // is a public action used in the manifest for receiving Alarm broadcasts
    // from the alarm manager.
    public static final String ALARM_ALERT_ACTION = "com.livemasjid.livemasjidandroid.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.livemasjid.livemasjidandroid.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.livemasjid.livemasjidandroid.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.livemasjid.livemasjidandroid.ALARM_DISMISS";

    // This is a private action used by the AlarmKlaxon to update the UI to
    // show the alarm has been killed.
    public static final String ALARM_KILLED = "com.livemasjid.livemasjidandroid.ALARM_KILLED";

    // Extra in the ALARM_KILLED intent to indicate to the user how long the
    // alarm played before being killed.
    public static final String ALARM_KILLED_TIMEOUT = "com.livemasjid.livemasjidandroid.ALARM_KILLED_TIMEOUT";
    ...
    // snooze alert.
    public static final String CANCEL_SNOOZE = "com.livemasjid.livemasjidandroid.CANCEL_SNOOZE";
    ...
    private static void clearSnoozeIfNeeded(Context context, long alarmTime) {
        ...
        SharedPreferences prefs =
                context.getSharedPreferences(AlarmClockFragment.PREFERENCES, 0);
    ...
    static void saveSnoozeAlert(final Context context, final int id,
        ...
        SharedPreferences prefs = context.getSharedPreferences(
        		AlarmClockFragment.PREFERENCES, 0);
        if (id == -1) {
            clearSnoozePreference(context, prefs);
        } else {
