...
public class AlarmProvider extends ContentProvider {
	private final static String TAG = AlarmProvider.class.getName();
    ...
    static {
        sURLMatcher.addURI("com.livemasjid.livemasjidandroid", "alarm", ALARMS);
        sURLMatcher.addURI("com.livemasjid.livemasjidandroid", "alarm/#", ALARMS_ID);
    }
